...
typedef enum				e_err
{
  ...
  ERROR_TOKEN_LIST_ADD_FAILED		= 15,
  ERROR_EMPTY_STRING			= 16,
  ERROR_UNEXPECTED_CHAR			= 17,
  ERROR_UNEXPECTED_EOS			= 18,
  ERROR_EXPECTED_OPERATOR		= 19,
  ERROR_CURSES_INIT_FAILED		= 20,
  ERROR_SETTERM_FAILED			= 21,
